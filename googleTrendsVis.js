document.addEventListener('DOMContentLoaded', function() {
  ...
  function createGoogleTrendsVisualization(data, gameData) {
    ...
    //greater than .5 = strong, positive direction, .3>=x>.5 = moderate, positive correlation
    //0>x>.3 = weak, positive correlation
    //vice versa for negative side
    if (correlation >= 0.5) {
      correlationDescription = "Strong positive relationship";
      correlationColor = "#28a745"; // darker green for strong positive
    } else if (correlation >= 0.3) {
      correlationDescription = "Moderate positive relationship";
      correlationColor = "#5cb85c"; // lighter green for moderate positive
    } else if (correlation >= 0.1) {
      correlationDescription = "Weak positive relationship";
      correlationColor = "#a3d7a3"; // Very light green for weak positive
    } else if (correlation <= -0.5) {
      correlationDescription = "Strong negative relationship";
      correlationColor = "#dc3545"; // Red for strong negative
    } else if (correlation <= -0.3) {
      correlationDescription = "Moderate negative relationship";
      correlationColor = "#f8a5ac"; // Light red for moderate negative
    } else if (correlation <= -0.1) {
        ...
        correlationTooltip.style('display', 'block')
          .html(`
            <div style="border-left: 4px solid ${correlationColor}; padding-left: 10px;">
              ...
              ${correlation > 0 ? "Higher game points tend to come with higher search interest" : 
                                correlation < 0 ? "Higher game points tend to come with lower search interest" : 
                                "No relationship between game points and search interest"}
            </div>
          `)
